export default function Lab1() {
    return (
      <div id="wd-lab1">
        <h2>Lab 1</h2>
        Student Name: Siyun He <br />
        Section: CS5610 60924 Web Development SEC 01 <br />
        <h3>HTML Examples</h3>
        <div id="wd-h-tag">
          <h4>Heading Tags</h4>
        ...
        <div id="wd-lists">
          ...
          <ol id="wd-your-favorite-recipe">
            ...
            <li>Use day-old rice if possible for better texture.</li>
            <li>
              Dice vegetables (e.g., carrots, onions), and optional proteins
              (e.g., chicken, shrimp, eggs).
            </li>
            <li>In a hot pan with oil, cook beaten eggs and set aside.</li>
            <li>Sauté vegetables and protein until cooked through.</li>
            <li>Add rice to the pan, breaking up clumps.</li>
            <li>Season with salt and pepper to taste.</li>
            <li>
              Return scrambled eggs, mix well, and stir-fry until evenly heated.
            </li>
          </ol>
          ...
          <ul id="wd-your-books">
            ...
            <li>The Power of Insensitivity</li>
        ...
        Please
        <a href="https://github.com/HEsiyun/kambaz-react-web-app/tree/a1" id="wd-github">click here</a>
        to check my github repo<br/>
      </div>
    );
  }